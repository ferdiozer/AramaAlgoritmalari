namespace AramaAlgoritma
{
    ...
    /// </summary>
    class Knuth_Morris_Pratt : AlgoritmaBase
    {
        private int[] m_kmpNext = null;

        public int[] kmpNext { get => m_kmpNext; }

        public Knuth_Morris_Pratt(string Metin, string AramaMetin) : base(Metin, AramaMetin)
        {

        }
        /// <summary>
        /// Kmp içindeki prefix oluşturan fonksiyonu çalıştırıp diziyi geri döndürür.
        /// </summary>
        /// <returns>KmpNext dizisi</returns>
        public bool PrefixOlustur_KMP()
        {
